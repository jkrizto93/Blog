...
@section('content')
		...
		<div class="box box-primary">
            <div class="box-header">
              ...
              <button class="btn btn-primary pull-right" data-toggle="modal" data-target="#myModal"><i class="fa fa-plus"></i>Crear usuarsios</button>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                	...
                	@foreach($users as $user)
                      ...
                      <td>{{$user->getRoleNames()->implode(', ')}}</td>
                        ...
                        <form method="user" action="{{route('admin.users.destroy',$user)}}" style="display: inline">
                          ...
                          <button class="btn btn-xs btn-danger" onclick="return confirm('¿Quiere eliminar esta usuarsios?')"><i class="fa fa-times"></i></button>
                        </form>
