...
<head>
    ...
    <meta name="description" content="@yield('meta-description','Este es el Blog de Zendero :v')">
...
<body>
    ...
    <!--contenido-->
   <!-- *Link reutilizable:v*   @include('partials.social-links',['description'=> 'Este es el Blog de Zendero :v'])-->
